...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  addon_profile {
    ...
    ingress_application_gateway {
              #  effective_gateway_id                 = var.waf_id
               enabled                              = true
               gateway_id                           = var.waf_id
              #  ingress_application_gateway_identity = [
              #      {
              #          client_id                 = var.waf_client_id
              #          object_id                 = var.waf_principal_id
              #          user_assigned_identity_id = var.waf_identity_id
              #       }
              #   ] 
          }
  }
